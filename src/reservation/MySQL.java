...
public class MySQL {
	...
	public MySQL() {
		...
		this.dbname  = "50213057";         // データベース名;
		this.url = "jdbc:mysql://" + server + "/" + dbname + "?useUnicode=true&characterEncoding=UTF-8";
		this.user = "50213057";         // データベース作成ユーザ名;
		this.password  = "50213057";     // データベース作成ユーザパスワード;
    ...
    public ResultSet getFacilityData(String facility_name){
